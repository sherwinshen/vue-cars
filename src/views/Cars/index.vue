  ...
  <div class="car-wrap">
    <div class="car-item">
      ...
      <main>
        ...
        <img class="cars-img" src="../../assets/images/pic001.jpg" alt="" />
      </main>
      <footer>
        <a href="javascript: void(0);" class="cars-park">某某停车场</a>
      </footer>
    </div>
  </div>
</template>
...
.car-item {
  ...
  border-radius: 24px;
  @include webkit-prefix(box-shadow, 0 0 18px 0 rgba(0, 0, 0, 0.2));
  @include webkit-prefix(box-sizing, border-box);
  display: flex;
